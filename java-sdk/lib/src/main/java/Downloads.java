...
public class Downloads {
    ...
    **/
    public .models.operations.GetFilesIdContentResponse getFilesIdContent(.models.operations.GetFilesIdContentRequest request) throws Exception {
        ...
        .models.operations.GetFilesIdContentResponse res = new .models.operations.GetFilesIdContentResponse() {{
            clientError = null;
        }};
