...
class Webhooks:
    ...
    def delete_webhooks_id(self, request: operations.DeleteWebhooksIDRequest) -> operations.DeleteWebhooksIDResponse:
        r"""Remove webhook
        Deletes a webhook.
        """
        ...
        url = utils.generate_url(base_url, "/webhooks/{webhook_id}", request.path_params)
    ...
    def get_webhooks(self, request: operations.GetWebhooksRequest) -> operations.GetWebhooksResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Webhooks])
                res.webhooks = out
        elif r.status_code == 403:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ClientError])
    ...
    def get_webhooks_id(self, request: operations.GetWebhooksIDRequest) -> operations.GetWebhooksIDResponse:
        r"""Get webhook
    ...
    def put_webhooks_id(self, request: operations.PutWebhooksIDRequest) -> operations.PutWebhooksIDResponse:
        r"""Update webhook
        Updates a webhook.
        """
