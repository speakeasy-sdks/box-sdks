...
class PostWebhooksRequestBodyTargetTypeEnum(str, Enum):
    FILE = "file"
    FOLDER = "folder"
...
class PostWebhooksRequestBodyTarget:
    r"""PostWebhooksRequestBodyTarget
    The item that will trigger the webhook
    """
    
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    type: Optional[PostWebhooksRequestBodyTargetTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    
class PostWebhooksRequestBodyWebhookTriggerEnum(str, Enum):
...
class PostWebhooksRequestBody:
    ...
    target: PostWebhooksRequestBodyTarget = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('target') }})
    triggers: list[PostWebhooksRequestBodyWebhookTriggerEnum] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('triggers') }})
    

@dataclasses.dataclass
class PostWebhooksRequest:
    request: Optional[PostWebhooksRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
