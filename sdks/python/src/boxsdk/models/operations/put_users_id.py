...
@dataclasses.dataclass
class PutUsersIDQueryParams:
    fields: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': False }})
    

@dataclass_json
@dataclasses.dataclass
class PutUsersIDRequestBodyNotificationEmail:
    r"""PutUsersIDRequestBodyNotificationEmail
...
class PutUsersIDRequestBodyRoleEnum(str, Enum):
    COADMIN = "coadmin"
    USER = "user"

class PutUsersIDRequestBodyStatusEnum(str, Enum):
    ACTIVE = "active"
    INACTIVE = "inactive"
...
class PutUsersIDRequestBody:
    ...
    enterprise: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('enterprise') }})
    ...
    is_password_reset_required: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_password_reset_required') }})
    ...
    notification_email: Optional[PutUsersIDRequestBodyNotificationEmail] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('notification_email') }})
    ...
    role: Optional[PutUsersIDRequestBodyRoleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('role') }})
    ...
    status: Optional[PutUsersIDRequestBodyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class PutUsersIDRequest:
    ...
    query_params: PutUsersIDQueryParams = dataclasses.field()
    request: Optional[PutUsersIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
