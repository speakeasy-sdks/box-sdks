...
class MetadataCascadePolicies:
    r"""MetadataCascadePolicies
    The part of an API response that describes marker
    based pagination
    """
    
    entries: Optional[list[shared_metadatacascadepolicy.MetadataCascadePolicy]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('entries') }})
