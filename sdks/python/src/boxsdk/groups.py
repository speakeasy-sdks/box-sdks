...
class Groups:
    ...
    def post_groups_terminate_sessions(self, request: operations.PostGroupsTerminateSessionsRequest) -> operations.PostGroupsTerminateSessionsResponse:
        r"""Create jobs to terminate user group session
        ...
        url = base_url.removesuffix("/") + "/groups/terminate_sessions"
        ...
        res = operations.PostGroupsTerminateSessionsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def put_groups_id(self, request: operations.PutGroupsIDRequest) -> operations.PutGroupsIDResponse:
        r"""Update group
