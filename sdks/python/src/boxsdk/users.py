...
class Users:
    ...
    def delete_users_id(self, request: operations.DeleteUsersIDRequest) -> operations.DeleteUsersIDResponse:
        ...
        def do_request():
            return client.request("DELETE", url, params=query_params)
    ...
    def post_users_terminate_sessions(self, request: operations.PostUsersTerminateSessionsRequest) -> operations.PostUsersTerminateSessionsResponse:
        r"""Create jobs to terminate users session
        ...
        url = base_url.removesuffix("/") + "/users/terminate_sessions"
        ...
        res = operations.PostUsersTerminateSessionsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SessionTerminationMessage])
                res.session_termination_message = out
    ...
    def put_users_id(self, request: operations.PutUsersIDRequest) -> operations.PutUsersIDResponse:
        r"""Update user
