...
export class Downloads {
  ...
  **/
  getFilesIdContent(
    req: operations.GetFilesIdContentRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetFilesIdContentResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetFilesIdContentRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetFilesIdContentResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
