...
func (s *Downloads) GetFilesIDContent(ctx context.Context, request operations.GetFilesIDContentRequest) (*operations.GetFilesIDContentResponse, error) {
	...
	res := &operations.GetFilesIDContentResponse{
