...
func (s *Workflows) PostWorkflowsIDStart(ctx context.Context, request operations.PostWorkflowsIDStartRequest) (*operations.PostWorkflowsIDStartResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/workflows/{workflow_id}/start", request.PathParams)
	...
	res := &operations.PostWorkflowsIDStartResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
