...
func (s *Users) PostUsersTerminateSessions(ctx context.Context, request operations.PostUsersTerminateSessionsRequest) (*operations.PostUsersTerminateSessionsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/users/terminate_sessions"
	...
	res := &operations.PostUsersTerminateSessionsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
