...
func (s *Tasks) DeleteTasksID(ctx context.Context, request operations.DeleteTasksIDRequest) (*operations.DeleteTasksIDResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/tasks/{task_id}", request.PathParams)
...
func (s *Tasks) GetFilesIDTasks(ctx context.Context, request operations.GetFilesIDTasksRequest) (*operations.GetFilesIDTasksResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/files/{file_id}/tasks", request.PathParams)
	...
	res := &operations.GetFilesIDTasksResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Tasks) PutTasksID(ctx context.Context, request operations.PutTasksIDRequest) (*operations.PutTasksIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/tasks/{task_id}", request.PathParams)
	...
	res := &operations.PutTasksIDResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
